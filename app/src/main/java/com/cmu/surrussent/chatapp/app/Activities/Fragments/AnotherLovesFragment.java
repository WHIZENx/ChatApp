...
public class AnotherLovesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_another_loves, container, false);
    ...
    private void lover_load() {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Lovers").child(userid);
